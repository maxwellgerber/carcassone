// The NPC brain as it was before the meeple-economy rewrite, kept verbatim for
// scripts/tourney.ts so new bots can be measured against the old one.
import { cloneState, deriveFeatures, getLegalPlacements, getMeepleOptions, placeMeeple, placeTile, type Features } from '../src/shared/engine.js';
import type { GameState, MeepleKind, NpcDifficulty, Placement } from '../src/shared/types.js';
